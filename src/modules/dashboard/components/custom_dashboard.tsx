  ...
  return (
    <>
      ...
      >
        ...
        <div className="grid min-h-0 flex-1 grid-rows-[minmax(0,1fr)] md:grid-cols-[minmax(14rem,18rem)_1fr]">
          <div className="max-h-[40vh] min-h-0 overflow-y-auto overscroll-contain md:h-full md:max-h-none">
