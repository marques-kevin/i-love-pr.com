...
const ROCKET_TIMES = [0, 0.07, 0.14, 0.22, 0.32, 0.43, 0.5, 0.56, 0.64, 0.73, 0.82, 0.9, 0.96, 1]
...
function RocketGeometry() {
  return (
    <>
      <path d={ROCKET_BODY} stroke="currentColor" strokeLinejoin="round" strokeWidth="1.5" />
      <path
...
function RocketTrails({ phase }: RocketTrailsProps) {
  const variants = phase === 'departing' ? departingThrustVariants : arrivingThrustVariants
