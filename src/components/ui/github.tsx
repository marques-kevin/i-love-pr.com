...
const tailLiftPath = 'M10 20.5675C8.18 21.24 6.48 21.04 4.86 19.94C3.05 18.7 1.08 16.05 0.36 13.6'

const tailSweepPath = 'M10 20.5675C8.2 21.18 6.34 20.72 4.68 19.26C2.82 17.62 0.48 14.65 0.82 12.55'

const tailCounterPath =
  'M10 20.5675C8.3 21.42 6.58 21.72 5.02 21.28C3.42 20.83 1.58 19.52 0.62 18.35'

const tailSettlePath = 'M10 20.5675C8.28 21.08 6.68 21.02 5.32 20.46C3.95 19.9 2.7 18.5 1.88 16.72'

const tailVariants: Variants = {
  normal: { d: tailRestPath },
  animate: {
    d: [tailRestPath, tailLiftPath, tailSweepPath, tailCounterPath, tailSettlePath, tailRestPath],
    transition: {
      duration: 0.72,
      ease: [0.77, 0, 0.175, 1],
