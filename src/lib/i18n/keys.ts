...
export const DYNAMICALLY_REFERENCED_MESSAGE_KEYS: MessageKey[] = [
  ...
  'app.nav.import_repository_label',
  'app.nav.import_repository_placeholder',
  'app.nav.import_repository_cancel',
  'app.nav.import_repository_confirm',
  'app.nav.import_repository_importing',
  'app.nav.import_repository_failed',
  'app.nav.import_repository_close',
  'app.nav.import_repository_dismiss',
  'app.nav.import_repository_succeeded',
  'app.nav.import_repository_background_hint',
  'app.nav.import_repository_progress_repo',
  'app.nav.import_repository_progress_count',
  'app.nav.import_repository_stage_downloading',
  'app.nav.import_repository_stage_writing_prs',
  'app.nav.import_repository_stage_writing_reviews',
  'app.nav.import_repository_stage_writing_files',
  'app.nav.import_repository_stage_saving_settings',
  'app.nav.import_repository_stage_building_facts',
  ...
  'repo_gallery.throughput',
  'repo_gallery.cycle',
  'repo_gallery.first_review',
  'repo_gallery.open_prs',
  'settings.theme',
