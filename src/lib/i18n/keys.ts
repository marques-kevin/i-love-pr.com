...
export const DYNAMICALLY_REFERENCED_MESSAGE_KEYS: MessageKey[] = [
  ...
  'app.nav.import_repository_step_download',
  'app.nav.import_repository_step_write',
  'app.nav.import_repository_step_facts',
  'app.nav.import_repository_failed',
  'app.nav.import_repository_banner_running',
  'app.nav.import_repository_banner_error',
  'app.share_import.error_title',
