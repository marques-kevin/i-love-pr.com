export const en_messages = {
  ...
  'app.nav.import_repository_close': 'Close',
  'app.nav.import_repository_dismiss': 'Dismiss',
  'app.nav.import_repository_succeeded': 'Imported {repo}',
  'app.nav.import_repository_background_hint':
    'You can close this dialog — the import continues in the background.',
  'app.nav.import_repository_progress_repo': 'Importing {repo}',
  'app.nav.import_repository_progress_count': '{completed} / {total}',
  'app.nav.import_repository_stage_downloading': 'Downloading snapshot',
  'app.nav.import_repository_stage_writing_prs': 'Writing pull requests',
  'app.nav.import_repository_stage_writing_reviews': 'Writing reviews',
  'app.nav.import_repository_stage_writing_files': 'Writing changed files',
  'app.nav.import_repository_stage_saving_settings': 'Saving settings',
  'app.nav.import_repository_stage_building_facts': 'Building metrics',
