...
export const fr_messages = define_locale_messages({
  ...
  'home.import_title': 'Importer un dépôt partagé',
  'home.import_description':
    'Collez le lien de partage d’un collègue pour importer son snapshot de PRs dans votre espace.',
  'home.import_label': 'Lien de partage',
  'home.import_placeholder': 'https://…/?import=…',
  'home.import_confirm': 'Importer le snapshot',
  'home.import_cancel': 'Annuler',
  'home.import_working': 'Import…',
  'home.import_done': '{count} PR importées dans {repo}.',
  'home.import_failed': 'Échec de l’import',
