...
export const fr_messages = define_locale_messages({
  ...
  'app.nav.import_title': 'Importer un dépôt partagé',
  'app.nav.import_description':
    'Collez un lien de partage d’un collègue pour importer son snapshot de tableau de bord (sans sync GitHub).',
  'app.nav.import_label': 'Lien de partage',
  'app.nav.import_placeholder': 'https://…/?import=…',
  'app.nav.import_cancel': 'Annuler',
  'app.nav.import_confirm': 'Importer',
  'app.nav.import_working': 'Import…',
  'app.nav.import_done': '{count} PR importées dans {repo}.',
  'app.nav.import_failed': 'Échec de l’import',
