...
export const fr_messages = define_locale_messages({
  ...
  'app.nav.import_repository_close': 'Fermer',
  'app.nav.import_repository_dismiss': 'Fermer',
  'app.nav.import_repository_succeeded': '{repo} importé',
  'app.nav.import_repository_background_hint':
    'Vous pouvez fermer cette fenêtre — l’import continue en arrière-plan.',
  'app.nav.import_repository_progress_repo': 'Import de {repo}',
  'app.nav.import_repository_progress_count': '{completed} / {total}',
  'app.nav.import_repository_stage_downloading': 'Téléchargement du snapshot',
  'app.nav.import_repository_stage_writing_prs': 'Écriture des pull requests',
  'app.nav.import_repository_stage_writing_reviews': 'Écriture des reviews',
  'app.nav.import_repository_stage_writing_files': 'Écriture des fichiers modifiés',
  'app.nav.import_repository_stage_saving_settings': 'Enregistrement des paramètres',
  'app.nav.import_repository_stage_building_facts': 'Calcul des métriques',
