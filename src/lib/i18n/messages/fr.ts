...
export const fr_messages = define_locale_messages({
  ...
  'app.nav.import_repository_step_prs': 'Écriture des pull requests…',
  ...
  'home.import_in_progress': 'Import de {repo}…',
  'home.import_in_progress_unnamed': 'Import du dépôt partagé…',
